...
const WhatsAppWidget = () => {
  ...
  return (
    <>
      <button onClick={() => { window.dataLayer = window.dataLayer || []; window.dataLayer.push({ event: 'whatsapp_button_click' }); setOpen(true); }} className="bt-whatsApp" aria-label="Fale conosco via WhatsApp">
